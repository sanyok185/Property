(() => {
    ...
    function menuInit() {
        if (document.querySelector(".header__filter")) {
            ...
            document.querySelector(".filter__close");
            document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".header__filter")) {
                    bodyLockToggle();
                    filter.classList.add("_show");
                }
            }));
            document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".filter__close")) {
                    bodyLockToggle();
            ...
            selectInput.addEventListener("input", (function() {
                selectOptionsItems.forEach((selectOptionsItem => {
                    if (selectOptionsItem.textContent.toUpperCase().includes(selectInput.value.toUpperCase())) {
                        selectOptionsItem.style.display = 'block';
                    } else {
    ...
    function rangeInit() {
        ...
        if (priceSlider) {
            ...
            var rangeSliderValueElement = document.querySelector(".item-filter__price");
    ...
    function rangeInit1() {
        const priceSlider1 = document.querySelector("#range_1");
        if (priceSlider1) {
            priceSlider1.getAttribute("data-from");
            priceSlider1.getAttribute("data-to");
            initialize(priceSlider1, {
                start: 0,
                connect: [ true, false ],
                step: 1,
                range: {
    ...
    function rangeInit2() {
        const rangeInit2 = document.querySelector("#range_2");
        if (rangeInit2) {
            rangeInit2.getAttribute("data-from");
            rangeInit2.getAttribute("data-to");
            initialize(rangeInit2, {
                start: 0,
                connect: [ true, false ],
                step: 1,
                range: {
            ...
            var rangeSliderValueElement = document.querySelector(".item-filter__price");
            rangeInit2.noUiSlider.on("update", (function(values, handle) {
                rangeSliderValueElement.innerHTML = values[handle];
            }));
        }
    }
    function rangeInit3() {
        const priceSlider3 = document.querySelector("#range_3");
        if (priceSlider3) {
            priceSlider3.getAttribute("data-from");
            priceSlider3.getAttribute("data-to");
            initialize(priceSlider3, {
                start: 0,
                connect: [ true, false ],
                step: 1,
                range: {
    ...
    function initSliders() {
        if (screenWidth > 767 && document.querySelector(".swiper-gallery")) {
            const gallerySwiper = new swiper_core_Swiper(".swiper-gallery", {
                modules: [ Scrollbar, freeMode, Grid, Mousewheel ],
                slidesPerView: "auto",
                spaceBetween: 24,
                freeMode: true,
                loop: false,
        ...
        if (screenWidth > 767 && document.querySelector(".swiper-popup")) {
            const miniSwiper = new swiper_core_Swiper(".swiper-popup-mini", {
            ...
            const popupSwiper = new swiper_core_Swiper(".swiper-popup", {
                modules: [ Thumb, Navigation ],
                slidesPerView: 1,
                draggable: true,
                speed: 600,
    ...
    if (document.querySelector(".user-header")) document.addEventListener("click", (e => {
        const targetElement = e.target;
    ...
    if (document.querySelector(".mobile-footer__profile")) {
        ...
        document.addEventListener("click", (e => {
            const targetElement = e.target;
            if (targetElement.closest(".mobile-footer__profile") && !targetElement.closest(".mobile-footer__sub-menu")) footerSubMenu.classList.toggle("_active");
            if (!targetElement.closest(".mobile-footer__sub-menu") && !targetElement.closest(".mobile-footer__profile")) footerSubMenu.classList.remove("_active");
        }));
    }
    if (document.querySelector(".item-filter__button")) {
        document.addEventListener("click", (e => {
            const target = e.target;
            const filterBodies = document.querySelectorAll(".item-filter__body");
            if (target.closest(".item-filter__button._open")) {
                target.closest(".item-filter__button").nextElementSibling.classList.toggle("_open");
                target.closest(".item-filter__button").classList.toggle("_open");
            } else if (target.closest(".item-filter__button") && !target.closest("._open")) {
                let filterButtons = document.querySelectorAll(".item-filter__button._open");
                if (filterButtons.length) {
                    for (let button of filterButtons) {
                        button.nextElementSibling.classList.remove("_open");
    ...
    if (document.querySelector(".tabs-account__add")) {
        const accountButtons = document.querySelectorAll(".tabs-account__add");
        for (let button of accountButtons) {
            const accountLink = button.nextElementSibling.closest(".tabs-account__links");
            ...
            document.addEventListener("click", (e => {
                const targetElement = e.target;
                if (!targetElement.closest(".tabs-account__links") && !targetElement.closest(".tabs-account__add")) accountLink.classList.remove("active");
            }));
        }
    }
    window["FLS"] = false;
